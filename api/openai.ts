...
export async function askOpenAI(question: string, plugin: qaPlugin) {
  ...
  let prompt2 = "Instructions: You are a helpful assistant called SecretaryGPT and will not engage in active conversation with the user. You will be given a question and the user's note files as context. You must answer the question based on the their notes only. If no answer can be found inform the user that no answer can be found for the given question from their notes."
